...
enum RouterVersion {
  DonaswapRouter = 'DonaswapRouter',
  DonaswapRouter02 = 'DonaswapRouter02'
}

describe('DonaswapRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.DonaswapRouter]: fixture.router,
        [RouterVersion.DonaswapRouter02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.DonaswapRouter]: 101876,
              [RouterVersion.DonaswapRouter02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.DonaswapRouter]: 138770,
              [RouterVersion.DonaswapRouter02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
